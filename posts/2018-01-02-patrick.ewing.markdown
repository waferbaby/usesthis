---
title: Patrick Ewing
summary: Game designer (Firewatch), web developer
categories:
- developer
- game
- web
...
My team (we're called _Chance Agency_) uses [Slack][] for all our creative coordination, and [appear.in][] for video conferencing.
