...
I'm fundamentally interested in resilience. Who and what do we depend upon? How can be intentionally interdependent at a human level while building systems, both social and technological, that can adapt to new conditions and lead to better futures? What can we practice now?
...
I started with the [AlphaSmart 3000][alphasmart-3000], which is a little bit cheaper, and has a fun [iMac][] aesthetic to it. The prefer the keyboard on the Neo 2, though, and it can fit a bit more text on the display at one time.
