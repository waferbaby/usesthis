...
I created [HomeSite][], [TopStyle][] and [FeedDemon][] for Windows, then switched to Android development a few years ago and created the Android versions of [Glassboard][glassboard-android] and [NewsGator Social Sites][social-sites-android].
