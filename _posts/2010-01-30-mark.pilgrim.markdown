---
layout: post
title: An interview with Mark Pilgrim
slug: mark.pilgrim
person: Mark Pilgrim
...
* Three monitors: two 24-inch Dell [Ultrasharp 2407WFP][2407wfp] monitors (rotated 90 degrees so they are "tallscreens" @ 1200 x 1920) on either side of a 27-inch [Samsung 275T+][275t-plus] @ 1920 x 1200.
* [Customizer 104][customizer-104] Black keyboard, which is the spiritual successor to the [IBM Model M][model-m].
...
* [Cyanogen ROM][cyanogen].
* Community Hero Mix theme.
* [Astrid][].
* [Twidroid][].
* [connectbot][].
* [Robo Defense][robo-defense] (Note to my previous editor: this is why your book was late. Note to my current editor: this is why your book is late, too.)
