---
layout: post
title: An interview with Rui Carmo
slug: rui.carmo
person: Rui Carmo
...
For those rare occasions when I absolutely must use some other OS, I use [Fusion][] or [VirtualBox][] (mostly depending on what kind of VM I need to set up).
